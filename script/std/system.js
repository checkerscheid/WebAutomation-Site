...
//# Revision     : $Rev:: 572                                                     $ #
//# Author       : $Author::                                                      $ #
//# File-ID      : $Id:: system.js 572 2024-03-20 06:52:42Z                       $ #
//#                                                                                 #
//###################################################################################
use system\wpInit;
use system\std;
...
$(document).ready(function() {
	...
	$('.ledcontainer').click( function() { document.documentElement.requestFullscreen(); });
...
function getOnlineAlarms() {
	...
	$.get('std.request.activealarm.' + CountAlarms + '.req', function(data) {
		...
		wpAlarmupdate = (updaterequired == 'True') ? true : false;
		if(wpAlarmupdate) {
			$('#onlinealarm tbody tr').each(function() {
		...
		if (updaterequired == 'True') TheAlarmTable.draw();
		setflttype();
		if(flttypefill == 'true') {
