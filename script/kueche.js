...
//# File-ID      : $Id:: kueche.js 505 2021-05-07 21:55:45Z checker               $ #
//#                                                                                 #
//###################################################################################
?> kueche */
...
p.page.load = function() {
	$('#kueche').on('click', '.pa-AufZu.bedienbar', function() {
	...
	$('#kueche').on('click', '.Ventil.bedienbar', function() {
		var headline = $(this).attr('data-popup');
		var id = $(this).attr('id');
		p.popup.title = 'Ventilbedienung';
		p.popup.AnalogSchieberegler(headline, id);
	});
	$('#kueche').on('click', '.ps-regler', function() {
